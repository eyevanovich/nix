...
- No-mistakes requires committed HEAD and a clean working tree. Verify the bootstrap commit is present and \`git status --porcelain\` is empty. If the tree is not clean, do not invoke no-mistakes or grant it custody; call task_run_update with phase failed and retain the tab and worktree for recovery.
